...
public class FireworksScannerImpl implements ScannerService {
    ...
    private String buildJsonPayload(String code) {
        ...
        // reasoning_effort:"none" disables the model's internal "thinking" pass.
        // Kimi/DeepSeek reasoning models on Fireworks don't route chain-of-thought
        // to a separate field by default - without this, the model's internal
        // reasoning ("The user wants me to review...") leaks straight into the
        // content field ahead of (or instead of) the actual JSON answer.
